...
<table align="center" style="width: 100%; max-width: 450px; font-family: Inter, sans-serif; border: 1px solid #f2f2f2;" >
    <tr>
        <td align="center" style="background-color: #5146E6; padding: 10px 10px; text-align: center;">
    ...
    <tr>
        <td align="center" style="padding-top: 40px; padding-bottom: 30px; background-color: #ffffff; text-align: center;">
    ...
    <tr>
        <td style="padding:10px 20px 2px 20px; text-align: center;">
            <p style=" margin: 1px; font-size: 15px; font-weight: 500; color: #727272;">We received a request to reset your password. Click the button below to reset it.</p>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:35px 20px 5px 20px;">
