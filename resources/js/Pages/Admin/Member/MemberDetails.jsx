...
export default function MemberDetails({ auth }) {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            if (searchTerm !== filters.search || statusFilter !== filters.status || dateRange !== filters.date_range) {
                router.get(
                    route("admin.members.details", member.uuid),
                    {
                        search: searchTerm,
                        status: statusFilter,
    ...
    const handleBack = () => {
        router.get(route('admin.members.dashboard'));
    };
        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="mt-[75px]">
                <div className="min-h-screen py-[40px] px-[15px]">
                    ...
                    <div className="cards border borderbx rounded-lg p-6 shadow-sm mb-6">
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{tasks.total || 0}</p>
                                </div>
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{tasks.running || 0}</p>
                                </div>
                                <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{tasks.completed || 0}</p>
                                </div>
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{task_instances.total_instances || 0}</p>
                                </div>
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{task_instances.pending_instances || 0}</p>
                                </div>
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{task_instances.in_progress_instances || 0}</p>
                                </div>
                                <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{task_instances.completed_instances || 0}</p>
                                </div>
                                <div className="p-3 rounded-lg bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400">
                                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                        ...
                        <div className="cards border borderbx rounded-lg p-4 shadow-sm">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="mt-1 text-2xl font-bold text-gray-900 dark:text-white">{task_instances.overdue_instances || 0}</p>
                                </div>
                    ...
                    {/* Search and Filters */}
                    <div className="cards border borderbx rounded-lg p-4 shadow-sm mb-6">
                        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col sm:flex-row gap-3">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#1a1f3d] text-black dark:text-white"
                                    value={searchTerm}
                            ...
                            <select
                                className="min-w-[150px] px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#1a1f3d] text-black dark:text-white"
                                value={statusFilter}
                            ...
                            <div className="relative flex-1" ref={datePickerRef}>
                                ...
                                <input
                                    ...
                                    className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-[#1a1f3d] text-black dark:text-white cursor-pointer"
                                    value={dateRange}
                                    readOnly
                            ...
                            <button
                                ...
                                className="flex items-center gap-[5px] px-[20px] py-[12px] text-[15px] text-gray-700 dark:text-gray-200 bg-white dark:bg-[#1a1f3d] border border-gray-300 dark:border-gray-600 rounded-[10px] hover:bg-gray-50 dark:hover:bg-[#131836]"
                            >
                                Reset
                            </button>
                        </form>
                    ...
                    {/* Tasks Table */}
                    <div className="cards border borderbx rounded-lg p-4 shadow-sm overflow-hidden">
                        <div className="p-[5px] mb-[15px] border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div className="overflow-x-auto">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead className="bg-gray-50 dark:bg-[#1a1f3d]">
                                    ...
                                    {tasks.data && tasks.data.length > 0 ? (
                                        tasks.data.map((task) => (
                                            <>
                                                <tr
                                                    key={task.uuid}
                                                    className="hover:bg-gray-50 dark:hover:bg-[#1a1f3d] cursor-pointer"
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${statusClasses[task.status]}`}>
                                                ...
                                                {expandedTask == task.uuid && (
                                                    <tr className="bg-gray-50 dark:bg-[#1a1f3d]">
                        ...
                        {/* Pagination */}
                        {tasks.data && tasks.data.length > 0 && (
                            <div className="px-6 py-3 bg-gray-50 dark:bg-[#1a1f3d] border-t border-gray-200 dark:border-gray-700 flex items-center justify-between">
                                ...
                                <div className="flex space-x-2">
                                    {tasks.prev_page_url && (
                                        <Link
                                            ...
                                            className="px-3 py-1 bg-white dark:bg-[#131836] border border-gray-300 dark:border-gray-600 rounded text-sm text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-[#1a1f3d]"
                                            preserveState
                                        >
                                            Previous
                                        </Link>
